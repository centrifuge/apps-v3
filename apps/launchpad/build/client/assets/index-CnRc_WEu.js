import{i as N,j as k,x as a,r as L}from"./index-DNyRCIwI.js";import{n as l,c as _,o as S,r as b}from"./if-defined-BWU6qkaf.js";import{T as A,D as Y}from"./index-DRqh2Fnh.js";import"./index-D_8N-8_c.js";import"./index-BpEQNy9N.js";import"./index-lWemKX21.js";import{f as v,z as p,e as O,R as z,O as V,h as E,A as W,W as F}from"./root-quzbZdsK.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
